<div class="flexslider welcome">
			<div class="slides">
				<div class="slide" style="background-image: url('img/background1.jpeg');">
					<div class="inner">
						<div class="container">
				...
				<div class="slide" style="background-image: url('img/background2.jpg');">
					<div class="inner">
						<div class="container">
							<div class="banner-wrapper">
				...
				<div class="slide" style="background-image: url('img/background3.jpg');">
					<div class="inner">
						<div class="container">
							<div class="banner-wrapper">
