<footer class="footer">
					...
					<div class="row">
						...
						<div class="col-sm-4">
							...
							<form action="scripts/contact.php" method="post" id="footer-contact-form" target="_blank">
								...
								<div class="form-group">
									<button type="submit" class="button solid block light-red">Send Message</button>
								</div> <!-- end .form-group -->
			...
			<div class="bottom">
				<span class="copyright">Copyright 2015. Todos os direitos reservados a Rodo Sider. Designed by WebForSite.</span>
			</div> <!-- end .bottom -->
		</footer> <!-- end .footer -->
